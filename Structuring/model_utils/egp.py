...
class EffiGlobalPointer(nn.Module):
    ...
    def forward(self, bert_output_raw, attention_mask):
        self.device = bert_output_raw.device
        outputs = self.dense_1(bert_output_raw)
        ...
        bias = torch.einsum('bnh->bhn', self.dense_2(bert_output_raw)) / 2
